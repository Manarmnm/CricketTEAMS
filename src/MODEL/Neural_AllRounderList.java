 ...
 * @author MASS MNM
 */
public class Neural_AllRounderList extends Allrounder_List{
    ...
    public Neural_AllRounderList(String Allrounder_ID, String PlayerName, String PlayerRole, String PlayerCategory, String Nationality, String MatchType, int TotalMatchs, double Bat_Strike_Rate, double Bat_Average, double Bowl_Economy, double Bowl_Average, int Bestbowl,String Srate_Weight,String BatAve_Weight,String BEcon_Weight,String BowlAve_Weight,int Result, String Error, String Epoc, String Sum) {
        super(Allrounder_ID, PlayerName, PlayerRole, PlayerCategory, Nationality, MatchType, TotalMatchs, Bat_Strike_Rate, Bat_Average, Bowl_Economy, Bowl_Average, Bestbowl,Srate_Weight, BatAve_Weight, BEcon_Weight, BowlAve_Weight, Result, Error, Epoc, Sum);
    }
